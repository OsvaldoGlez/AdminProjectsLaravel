...
@section('main')
	...
	<div class="container" style="margin-top:80px">
        ...
        <br> 
        @endif
	    <h1 class="text-info text-center"><strong>Editar Proyecto</strong></h1>
	    <hr>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="codigo_proyecto" value="{{ $proyecto->codigo_proyecto }}" required>
                        </div>
                    </div>
                    <!-- Fin Codigo Proyecto -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" name="descripcion" cols="20" rows="5">{{ $proyecto->descripcion }}</textarea>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control" name="fecha_entrega" value="{{ $proyecto->fecha_entrega }}">
                        </div>
                    </div>
                    <!-- Fin Fecha Entrega -->
